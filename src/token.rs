...
pub fn generate_jwt_token(user_id: uuid::Uuid,
                          ttl: i64,
                          private_key: String, ) -> Result<TokenDetails, jsonwebtoken::errors::Error> {
    ...
    let claims = TokenClaims {
        sub: token_details.token_uuid.to_string(),
...
pub fn verify_jwt_token(public_key: String, token: &str)
